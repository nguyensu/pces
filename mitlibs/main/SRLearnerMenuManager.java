...
import pes.core.gp.evogpj.algorithm.SymbRegMOO;
import pes.core.gp.evogpj.gp.Individual;
import pes.core.gp.evogpj.preprocessing.NormalizeData;
...
public class SRLearnerMenuManager {
            ...
            if (args[2].equals("-minutes")) {
                ...
                if(args.length==6 || args.length==8){
                    if(args[4].equals("-properties")){ // JAVA WITH PROPERTIES
                        ...
                        // run pes.core.gp.evogpj with modified properties
    ...
    //java -jar pes.core.gp.evogpj.jar -predictions path_to_data -o filename -integer true -scaled path_to_scaled_models
    ...
    //java -jar pes.core.gp.evogpj.jar -test path_to_data -integer true -scaled path_to_scaled_models
    ...
    //java -jar pes.core.gp.evogpj.jar -testinfix path_to_data -integer true -scaled path_to_scaled_models
    ...
    //java -jar pes.core.gp.evogpj.jar -scale path_to_data
