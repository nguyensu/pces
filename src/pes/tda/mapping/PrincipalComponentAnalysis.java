...
/**
 * Created by nguye on 11/08/2017.
 */
...
public class PrincipalComponentAnalysis {
    ...
    public void addSample( double[] sampleData ) {
        if( A.getNumCols() != sampleData.length )
            throw new IllegalArgumentException("Unexpected sample sizes");
    ...
    public void computeBasis( int numComponents ) {
        ...
        if( numComponents > sampleIndex )
            throw new IllegalArgumentException("More data needed to startMapping the desired number of components");

        this.numComponents = numComponents;

        // startMapping the mean of all the samples
