...
public final class Parameters {
    ...
    public final static class Defaults {
         ...
         * crossover rate
         */
        public static final double XOVER_RATE = 0.85;
         ...
         */
        public static final String JSON_LOG_PATH= "pes.core.gp.evogpj-log.json";

        /**
         * path to the file where the population is serialized
         */
        public static final String POP_SAVE_FILENAME = "pes.core.gp.evogpj-population.ser";
