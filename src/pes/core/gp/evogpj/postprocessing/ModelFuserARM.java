 ...
 * 
 */
package pes.core.gp.evogpj.postprocessing;
...
public class ModelFuserARM {
    ...
    public ModelFuserARM(String aTrainingSet, int aNumberOfFeatures, Population aPop,int aNumIters,boolean aRound){
    ...
    private void steps0TO3(){ 
        ...
        indexSplit = Math.round(numberOfLines / 2);
        ...
        for(int j=0;j<numModels;j++){
            ...
            double firstTermExp = ((-numberOfLines/2) * Math.log(sigmaEst));
