...
import pes.core.gp.evogpj.bool.BooleanFunction;
...
/**
 * Implements Bayesian empirical risk fitness function.
 * 
 * @author Ignacio Arnaldo
 */
public class RT_CostJava extends FitnessFunction {
     ...
     */
    public RT_CostJava(DataJava aData,ArrayList<Interval> aIntervals,double aWFP, double aWFN, int aNumThreads) {
        this.data = aData;
    ...
    public void eval(Individual ind) {
        ...
        //ind.setFitness(RT_CostJava.FITNESS_KEY, error);
        ind.setRTCost(error);
        func = null;
    }
    ...
    public void evalPop(Population pop) {
        ...
        for(int i=0;i<numThreads;i++){
            ...
            try {
                ...
                Logger.getLogger(RT_CostJava.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
