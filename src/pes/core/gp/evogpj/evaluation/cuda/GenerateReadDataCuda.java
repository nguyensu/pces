...
public class GenerateReadDataCuda {
    ...
    private void generateMainScaled(String dataset,int numberOfLines,int numberOfVars,int numberOfResults){
        ...
        cCode += "\t\t// SCALE RESULT\n";
        cCode += "\t\tint index = numberOfPoints*numberOfVars + i;\n";
    ...
    public void generateCode(String dataset,int numberOfLines,int numberOfVars,int numberOfResults){
        generateHeaders();
        generateMainScaled(dataset,numberOfLines,numberOfVars,numberOfResults);
    }
