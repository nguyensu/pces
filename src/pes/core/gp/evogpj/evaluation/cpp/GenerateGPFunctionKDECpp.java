...
/**
 * Just in time C++ code generation to evaluate classifier errors obtained with
 * the GPFuncion MAP algorithm
 * @author Ignacio Arnaldo
 */
public class GenerateGPFunctionKDECpp {

    FileWriter fw;
    Expression[] expressions;

    public GenerateGPFunctionKDECpp(String fileName) throws IOException {
        expressions = null;
    ...
    private void translate2CPP(int indexExpression, String instruction) throws IOException {
    ...
    private void generateGPFunctionKDEIndividual(int index) throws IOException {
    ...
    private void generateMain(int numberOfIndividuals, int numberOfThreads) throws IOException {
     ...
     * @throws IOException
     */
    public void generateCode(int numberOfIndividuals, int numberOfLines, int numberOfVars, 
            int numberOfResults,int numberOfThreads) throws IOException {
        generateHeaders(numberOfIndividuals, numberOfLines, numberOfVars, numberOfResults);
        for (int i = 0; i < numberOfIndividuals; i++) {
            generateGPFunctionKDEIndividual(i);
        }
