 ...
 *
 */
package pes.core.gp.evogpj.test;
...
/**
 * Test linearly scaled symbolic regression models in infix form
 * 
 * @author Ignacio Arnaldo
 */
public class TestSRInfixScaledModels {
     ...
     */
    public TestSRInfixScaledModels(String aPathToData, String aPathToPop,boolean aRound) throws IOException, ClassNotFoundException {
        pathToData = aPathToData;
        pathToPop = aPathToPop;
        round = aRound;
        this.data = new CSVDataJava(pathToData);
        readInfixScaledModels(pathToPop);
    }

    
    private void readInfixScaledModels(String filePath) throws IOException, ClassNotFoundException{
