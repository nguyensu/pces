...
public class AdaptiveChartingEnsembleGPrcjs extends TGPcore {
    /**
     ...
     */
    public AdaptiveChartingEnsembleGPrcjs(long seed, PrintWriter writer) {
        super (seed, writer);
    }
...
//                break;
            ...
            for (int indivs = 0; indivs < TRIALSIZE; indivs++) {
                ...
                approximatefit[indivs] = (surrogate_near_gen + Mapper.gngmodel.surrogate_gng(trialpop[indivs].phenotype))*duplicate(trialpop[indivs]);
